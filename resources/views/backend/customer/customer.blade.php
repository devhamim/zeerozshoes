                ...
                <div class="card-body">
                    <div class="row align-items-center m-l-0">
                        ...
                        <div class="col-sm-6 text-right">
                            <button class="btn btn-success btn-sm mb-3 btn-round" data-toggle="modal" data-target="#user_register"><i class="feather icon-plus"></i> Customer</button>
                        </div>
                    </div>
                            ...
                            <tbody>
                                @foreach ($customer_list as $sl=>$customer)
                                    <tr>
                                        ...
                                        <td>{{$customer->customer_phone == null ? 'null': $customer->customer_phone}}</td>
