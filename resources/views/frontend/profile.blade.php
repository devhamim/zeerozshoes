                    ...
                    <div class="dashboard_author px-2 py-5">
                        <div class="dash_auth_thumb circle p-1 border d-inline-flex mx-auto mb-2">
                            @if(Auth::guard('customerlogin')->user()->photo == null)
                                <img src="{{ Avatar::create(Auth::guard('customerlogin')->user()->name)->toBase64() }}" class="img-fluid circle" width="100" alt="" />
                            @else
                    ...
                    <form class="row m-0" action="{{ route('customer.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="phone" class="form-control" value="{{ Auth::guard('customerlogin')->user()->phone }}" />
                            </div>
                        </div>
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group">
                                <label class=" text-dark ft-medium">Photo</label>
