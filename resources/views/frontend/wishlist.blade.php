                ...
                <div class="d-block border rounded mfliud-bot">
                    <div class="dashboard_author px-2 py-5">
                        ...
                        <div class="dash_caption">
                            ...
                            <span class="text-muted smalls">{{ Auth::guard('customerlogin')->user()->address }}</span>
                        </div>
                    </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                        <div class="product_grid card b-0">
                            @if($wish->rel_to_pro->discount != null)
                                <div class="badge bg-danger text-white position-absolute ft-regular ab-left text-upper">%{{ $wish->rel_to_pro->discount }}</div>
                            @endif
                            <a href="{{ route('wish.remove', $wish->id) }}" class="btn btn_love position-absolute ab-right theme-cl"><i class="fas fa-times"></i></a>
                            <div class="card-body p-0">
                                <div class="shop_thumb position-relative">
                                    <a class="card-img-top d-block overflow-hidden" href="{{ route('singel.product', $wish->rel_to_pro->slug) }}"><img class="card-img-top" src="{{ asset('uplode/product') }}/{{ $wish->rel_to_pro->thumbnail }}" alt="..."></a>
                                </div>
                            </div>
                            <div class="card-footers b-0 pt-3 px-2 bg-white d-flex align-items-start justify-content-center">
                                <div class="text-left">
                                    <div class="text-center">
                                        <h5 class="fw-bolder fs-md mb-0 lh-1 mb-1"><a href="{{ route('singel.product', $wish->rel_to_pro->slug) }}">{{ $wish->rel_to_pro->title }}</a></h5>
                                        <div class="elis_rty"><span class="ft-bold fs-md text-dark">TK {{ number_format($wish->rel_to_pro->total_price) }}</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
